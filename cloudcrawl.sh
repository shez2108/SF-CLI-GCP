...
${filename}_sf_crawls._internal ~/crawl-data/internal_all_clean${now}.csv

bq load --autodetect --source_format=CSV --allow_quoted_newlines --allow_jagged_rows --ignore_unknown_values \
${filename}_sf_crawls._directives ~/crawl-data/directives_all_clean${now}.csv

bq load --autodetect --source_format=CSV --allow_quoted_newlines --allow_jagged_rows --ignore_unknown_values \
${filename}_sf_crawls._inlinks ~/crawl-data/all_inlinks_clean${now}.csv
